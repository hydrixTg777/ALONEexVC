...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="• ᴍᴇɴᴜ •", callback_data="stream_menu_panel"),
    ...
    if isinstance(u, StreamAudioEnded) or isinstance(u, StreamVideoEnded):
        ...
        if queue == 1:
            ...
            await bot.send_message(
                chat_id,
                "🤯 sᴏᴍᴇᴛʜɪɴɢ ɢᴏɴᴇ ᴡʀᴏɴɢ ʙᴀʙʏ\n\n» **ᴄʟᴇᴀʀɪɴɢ** ǫᴜᴇᴜᴇ ᴀɴᴅ ʟᴇᴀᴠɪɴɢ ᴠɪᴅᴇᴏᴄʜᴀᴛ.",
            )
        else:
            await bot.send_message(
                chat_id,
                f"💫 **ᴩʟᴀʏɪɴɢ ɴᴇxᴛ ᴛʀᴀᴄᴋ**\n\n📌 **ᴛɪᴛʟᴇ:** [{queue[0]}]({queue[1]}) | `{queue[2]}`\n💭 **ɢʀᴏᴜᴩ:** `{chat_id}`",
